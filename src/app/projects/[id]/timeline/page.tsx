...
export default async function TimelinePage({ params }: { params: { id: string } }) {
  ...
  return (
    <div>
      ...
      <h1 className="font-display text-2xl text-teal-700 mb-1">Mémoire du projet</h1>
      ...
      <div className="space-y-6">
        {Array.from(grouped.entries()).map(([date, items]) => (
          <div key={date}>
            <div className="text-sm font-medium text-teal-700 mb-2">{date}</div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mt-10">
        <div>
          <h2 className="font-display text-xl text-teal-700 mb-3">Points de vigilance</h2>
          ...
          <h2 className="font-display text-xl text-teal-700 mb-3 mt-8">Backlog / amélioration continue</h2>
        ...
        <div>
          <h2 className="font-display text-xl text-teal-700 mb-3">Documents & échanges</h2>
