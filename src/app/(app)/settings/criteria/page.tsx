  ...
  return (
    <div>
      ...
      <p className="text-sm text-muted mb-6 max-w-2xl">
        Checklists des étapes Kick-off, Préparation et Clôture. Le modèle par défaut s'applique à toute initiative dont le
        type n'a pas sa propre liste. Les autres étapes (Cadrage, Déploiement, Validation, Formation &
        Accompagnement, Mise en production, Stabilisation) sont calculées automatiquement à partir des données de
        l'initiative et ne se configurent pas ici.
      </p>
