  ...
  return (
    <div>
      ...
      <section>
        ...
        <TrainingForm initiativeId={params.id} establishments={initiative.establishments.map((e) => e.establishment)} />
      ...
      <section className="mt-10 mb-4">
        ...
        <KpiForm initiativeId={params.id} defaultCategorie="adoption" />
